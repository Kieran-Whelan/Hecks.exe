package me.frogdog.frogclient.module.impl.toggle.render.clickgui.item;
...
import me.frogdog.frogclient.module.impl.toggle.render.clickgui.item.properties.BooleanButton;
import me.frogdog.frogclient.module.impl.toggle.render.clickgui.item.properties.EnumButton;
import me.frogdog.frogclient.module.impl.toggle.render.clickgui.item.properties.NumberSlider;
...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!this.items.isEmpty()) {
            ...
            Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(Frog.getInstance().MODID , "textures/watermark.png"));
